...
namespace performance {
	...
	static std::string casefold(const char* text)
	{
		...
		if ((converted_size = utf8casefold(text, text_size, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors)) == 0 ||
		...
		utf8casefold(text, text_size, &converted[0], converted_size, UTF8_LOCALE_UNAFFECTED, nullptr);
