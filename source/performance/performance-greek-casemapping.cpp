...
PERF_TEST_F(GreekCaseMapping, Uppercase)
{
	int32_t e;
...
PERF_TEST_F(GreekCaseMapping, Lowercase)
{
	int32_t e;
...
PERF_TEST_F(GreekCaseMapping, Titlecase)
{
	int32_t e;
...
PERF_TEST_F(GreekCaseMapping, Casefold)
{
	int32_t e;
...
PERF_TEST_F(GreekCaseMapping, Locale)
{
	int32_t e;
