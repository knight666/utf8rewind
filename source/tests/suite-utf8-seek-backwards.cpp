...
TEST(Utf8SeekBackwards, OneByteSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -2, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -3, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteSingleOverlongThreeBytes)
{
	...
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -4, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteSingleOverlongFourBytes)
{
	...
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -5, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteSingleOverlongFiveBytes)
{
	...
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteSingleOverlongSixBytes)
{
	...
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -7, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteMultiple)
{
	...
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -9, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -10, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -11, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -12, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, OneByteMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 14, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 13, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 12, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -9, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -10, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -11, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -12, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -13, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -14, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -15, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, TwoBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -9, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, ThreeBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 12, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -5, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, ThreeBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 26, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 23, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 22, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 21, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 20, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 19, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 16, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 15, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 14, strlen(t), 0, -9, SEEK_CUR);
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -10, SEEK_CUR);
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -11, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -12, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -13, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -14, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -15, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -16, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -17, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FourBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 16, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 12, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -5, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FourBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FourBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 30, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 26, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 25, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 24, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 23, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 19, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 18, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 17, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 13, strlen(t), 0, -9, SEEK_CUR);
	EXPECT_SEEKEQ(t, 12, strlen(t), 0, -10, SEEK_CUR);
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -11, SEEK_CUR);
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -12, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -13, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -14, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -15, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -16, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FiveBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 15, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -4, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FiveBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, FiveBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 17, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 12, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, SixBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ(t, 11, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}
...
TEST(Utf8SeekBackwards, SixBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 20, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 14, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 13, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 0, strlen(t), 0, -6, SEEK_CUR);
}

TEST(Utf8SeekBackwards, IllegalByteSingleFirst)
{
	const char* t = "\xFE";
...
TEST(Utf8SeekBackwards, IllegalByteSingleLast)
{
	const char* t = "\xFF";
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongOneByte)
{
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongTwoBytes)
{
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongThreeBytes)
{
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongFourBytes)
{
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongFiveBytes)
{
...
TEST(Utf8SeekBackwards, IllegalByteSingleOverlongSixBytes)
{
...
TEST(Utf8SeekBackwards, IllegalByteMultiple)
{
...
TEST(Utf8SeekBackwards, IllegalByteMultipleOverlong)
{
	const char* t = "\xFE\x8A\x99\x9A"
					"\xFF\x87\x8A"
					"\xFF\x9A\xA6\x8A";

	EXPECT_SEEKEQ(t, 10, strlen(t), 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 9, strlen(t), 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 8, strlen(t), 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 7, strlen(t), 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 6, strlen(t), 0, -5, SEEK_CUR);
	EXPECT_SEEKEQ(t, 5, strlen(t), 0, -6, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, strlen(t), 0, -7, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, strlen(t), 0, -8, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, strlen(t), 0, -9, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, strlen(t), 0, -10, SEEK_CUR);
...
TEST(Utf8SeekBackwards, StringFromMiddle)
{
	...
	EXPECT_SEEKEQ(t, 5, 6, 0, -1, SEEK_CUR);
	EXPECT_SEEKEQ(t, 4, 6, 0, -2, SEEK_CUR);
	EXPECT_SEEKEQ(t, 3, 6, 0, -3, SEEK_CUR);
	EXPECT_SEEKEQ(t, 2, 6, 0, -4, SEEK_CUR);
	EXPECT_SEEKEQ(t, 1, 6, 0, -5, SEEK_CUR);
