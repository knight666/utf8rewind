...
TEST(Utf8SeekForward, FourBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ2(t, 4, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FourBytesSingleOverlongThreeBytes)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 4, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FourBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 4, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 8, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 16, 0, 0, 4, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FourBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ2(t, 10, 0, 0, 6, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FourBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 10, 0, 0, 4, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 11, 0, 0, 5, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 15, 0, 0, 6, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 16, 0, 0, 7, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 17, 0, 0, 8, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FiveBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 15, 0, 0, 3, SEEK_CUR);
}
...
TEST(Utf8SeekForward, FiveBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 11, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 4, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 13, 0, 0, 5, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 18, 0, 0, 6, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 19, 0, 0, 7, SEEK_CUR);
}
...
TEST(Utf8SeekForward, SixBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 2, SEEK_CUR);
}
...
TEST(Utf8SeekForward, SixBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 18, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 24, 0, 0, 4, SEEK_CUR);
}
...
TEST(Utf8SeekForward, SixBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ2(t, 14, 0, 0, 5, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 16, 0, 0, 6, SEEK_CUR);
}
...
TEST(Utf8SeekForward, SixBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 2, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 13, 0, 0, 3, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 14, 0, 0, 4, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 20, 0, 0, 5, SEEK_CUR);
	EXPECT_SEEKEQ2(t, 21, 0, 0, 6, SEEK_CUR);
}
