...
TEST_F(QuickbrownCaseMapping, DanishUppercase)
{
  ...
  WOLTHER SPILLEDE P\xC3\x85 XYLOFON.", eu.c_str());
	...
	size_t l = utf8toupper(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* au = new char[l + 1];
	utf8toupper(i.c_str(), i.size() - 1, au, l, UTF8_LOCALE_UNAFFECTED, &errors);
	au[l] = 0;
...
TEST_F(QuickbrownCaseMapping, DanishLowercase)
{
  ...
  wolther spillede p\xC3\xA5 xylofon.", el.c_str());
	...
	size_t l = utf8tolower(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* al = new char[l + 1];
	utf8tolower(i.c_str(), i.size() - 1, al, l, UTF8_LOCALE_UNAFFECTED, &errors);
	al[l] = 0;
...
TEST_F(QuickbrownCaseMapping, DanishTitlecase)
{
  ...
  Wolther Spillede P\xC3\xA5 Xylofon.", et.c_str());
	...
	size_t l = utf8totitle(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* at = new char[l + 1];
	utf8totitle(i.c_str(), i.size() - 1, at, l, UTF8_LOCALE_UNAFFECTED, &errors);
	at[l] = 0;
...
TEST_F(QuickbrownCaseMapping, TurkishUppercase)
{
	...
	size_t l = utf8toupper(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_TURKISH, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* au = new char[l + 1];
	utf8toupper(i.c_str(), i.size() - 1, au, l, UTF8_LOCALE_TURKISH, &errors);
	au[l] = 0;
...
TEST_F(QuickbrownCaseMapping, TurkishLowercase)
{
	...
	size_t l = utf8tolower(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_TURKISH, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* al = new char[l + 1];
	utf8tolower(i.c_str(), i.size() - 1, al, l, UTF8_LOCALE_TURKISH, &errors);
	al[l] = 0;
...
TEST_F(QuickbrownCaseMapping, TurkishTitlecase)
{
	...
	size_t l = utf8totitle(i.c_str(), i.size() - 1, nullptr, 0, UTF8_LOCALE_TURKISH, &errors);
	EXPECT_NE(0, l);
	ASSERT_EQ(0, errors);

	char* at = new char[l + 1];
	utf8totitle(i.c_str(), i.size() - 1, at, l, UTF8_LOCALE_TURKISH, &errors);
	at[l] = 0;
