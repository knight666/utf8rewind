...
TEST(Utf8ToLower, BasicLatinSingleUppercase)
{
	...
	EXPECT_EQ(1, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("g", b);
...
TEST(Utf8ToLower, BasicLatinMultipleUppercase)
{
	...
	EXPECT_EQ(5, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, BasicLatinMultipleLowercase)
{
	...
	EXPECT_EQ(4, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, BasicLatinMultipleUnaffected)
{
	...
	EXPECT_EQ(7, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("(-(#)-)", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8ToLower, BasicLatinWord)
{
	...
	EXPECT_EQ(8, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, BasicLatinSentence)
{
	...
	EXPECT_EQ(12, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, BasicLatinAmountOfBytes)
{
	...
	EXPECT_EQ(6, utf8tolower(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8ToLower, BasicLatinNotEnoughSpace)
{
	...
	EXPECT_EQ(3, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("int", b);
...
TEST(Utf8ToLower, GeneralCategoryCaseMappedSingleUppercase)
{
	...
	EXPECT_EQ(2, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GeneralCategoryCaseMappedMultipleLowercase)
{
	...
	EXPECT_EQ(6, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GeneralCategoryCaseMappedWord)
{
	...
	EXPECT_EQ(18, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GeneralCategoryCaseMappedSentence)
{
	...
	EXPECT_EQ(36, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GeneralCategoryCaseMappedAmountOfBytes)
{
	...
	EXPECT_EQ(8, utf8tolower(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8ToLower, GraphemeClusterSingleLowercase)
{
	...
	EXPECT_EQ(9, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterSingleTitlecase)
{
	...
	EXPECT_EQ(10, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterMultipleUppercase)
{
	...
	EXPECT_EQ(24, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterMultipleLowercase)
{
	...
	EXPECT_EQ(28, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterMultipleTitlecase)
{
	...
	EXPECT_EQ(27, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterMultipleUnaffected)
{
	...
	EXPECT_EQ(34, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterWord)
{
	...
	EXPECT_EQ(33, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterSentence)
{
	...
	EXPECT_EQ(64, utf8tolower(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, GraphemeClusterAmountOfBytes)
{
	...
	EXPECT_EQ(7, utf8tolower(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8ToLower, InvalidCodepointAmountOfBytes)
{
	...
	EXPECT_EQ(12, utf8tolower(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8ToLower, InvalidData)
{
	...
	EXPECT_EQ(0, utf8tolower(nullptr, 1, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, OverlappingParametersFits)
{
	...
	EXPECT_EQ(6, utf8tolower(i, is, o, os, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8ToLower, OverlappingParametersStartsEqual)
{
	...
	EXPECT_EQ(0, utf8tolower(i, is, o, os, UTF8_LOCALE_UNAFFECTED, &errors));
