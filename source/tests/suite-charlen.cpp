...
{
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x80'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x81'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x82'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x83'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x84'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x85'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x86'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x87'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x88'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x89'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8A'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8B'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8C'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8D'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8E'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x8F'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x90'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x91'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x92'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x93'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x94'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x95'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x96'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x97'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x98'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x99'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9A'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9B'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9C'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9D'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9E'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\x9F'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA0'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA1'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA2'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA3'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA4'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA5'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA6'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA7'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA8'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xA9'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB0'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB1'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB2'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB3'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB4'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB5'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB6'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB7'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB8'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xB9'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBA'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBB'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBC'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBD'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBE'));
	EXPECT_EQ(UTF8_ERR_INVALID_CHARACTER, utf8charlen('\xBF'));
