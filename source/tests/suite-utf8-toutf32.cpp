...
TEST(ToUtf32, StringEndsInMiddle)
{
...
TEST(ToUtf32, StringDataSizeUnder)
{
	const char* i = "Tree";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, StringDataSizeOver)
{
	const char* i = "Bark";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, StringBufferTooSmall)
{
...
TEST(ToUtf32, AsciiMalformedContinuationByteFirst)
{
	const char* i = "\x80";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, AsciiMalformedContinuationByteLast)
{
	const char* i = "\xBF";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, AsciiMalformedContinuationByteCombined)
{
	const char* i =
...
TEST(ToUtf32, AsciiIllegalByteFE)
{
	const char* i = "\xFE";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, AsciiIllegalByteFEInString)
{
...
TEST(ToUtf32, AsciiIllegalByteFF)
{
	const char* i = "\xFF";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, AsciiIllegalByteFFInString)
{
...
TEST(ToUtf32, TwoBytesOverlongNull)
{
...
TEST(ToUtf32, TwoBytesOverlongMaximum)
{
...
TEST(ToUtf32, TwoBytesLonelyStartFirst)
{
	const char* i = "\xC0 ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, TwoBytesLonelyStartLast)
{
	const char* i = "\xDF ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, TwoBytesLonelyStartCombined)
{
	const char* i =
...
TEST(ToUtf32, TwoBytesNotEnoughData)
{
	const char* i = "\xC2";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, ThreeBytesOverlong)
{
...
TEST(ToUtf32, ThreeBytesOverlongNull)
{
...
TEST(ToUtf32, ThreeBytesOverlongMaximum)
{
...
TEST(ToUtf32, ThreeBytesLonelyStartFirst)
{
	const char* i = "\xE0 ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, ThreeBytesLonelyStartLast)
{
	const char* i = "\xEF ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, ThreeBytesLonelyStartCombined)
{
	const char* i =
...
TEST(ToUtf32, ThreeBytesNotEnoughData)
{
...
TEST(ToUtf32, FourBytesOverlong)
{
...
TEST(ToUtf32, FourBytesOverlongNull)
{
...
TEST(ToUtf32, FourBytesOverlongFirst)
{
...
TEST(ToUtf32, FourBytesOverlongLast)
{
...
TEST(ToUtf32, FourBytesOverlongMaximum)
{
...
TEST(ToUtf32, FourBytesLonelyStartFirst)
{
	const char* i = "\xF0 ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, FourBytesLonelyStartLast)
{
	const char* i = "\xF7 ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, FourBytesLonelyStartCombined)
{
	const char* i =
...
TEST(ToUtf32, FourBytesNotEnoughData)
{
...
TEST(ToUtf32, FiveBytesOverlong)
{
...
TEST(ToUtf32, FiveBytesOverlongFirst)
{
...
TEST(ToUtf32, FiveBytesOverlongLast)
{
...
TEST(ToUtf32, FiveBytesOverlongNull)
{
...
TEST(ToUtf32, FiveBytesOverlongMaximum)
{
...
TEST(ToUtf32, FiveBytesLonelyStartFirst)
{
	const char* i = "\xF8 ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, FiveBytesLonelyStartLast)
{
	const char* i = "\xFB ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, FiveBytesLonelyStartCombined)
{
	const char* i =
		"\xF8 \xF9 \xFA \xFB ";
	const size_t s = 256;
...
TEST(ToUtf32, FiveBytesNotEnoughData)
{
...
TEST(ToUtf32, SixBytesOverlongFirst)
{
...
TEST(ToUtf32, SixBytesOverlongLast)
{
...
TEST(ToUtf32, SixBytesOverlongNull)
{
...
TEST(ToUtf32, SixBytesOverlongMaximum)
{
...
TEST(ToUtf32, SixBytesLonelyStartFirst)
{
	const char* i = "\xFC ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, SixBytesLonelyStartLast)
{
	const char* i = "\xFD ";
	const size_t s = 256;
	unicode_t o[s] = { 0 };
...
TEST(ToUtf32, SixBytesLonelyStartCombined)
{
	const char* i =
		"\xFC \xFD ";
	const size_t s = 256;
...
TEST(ToUtf32, SixBytesNotEnoughData)
{
...
TEST(ToUtf32, SixBytesNotEnoughSpace)
{
...
TEST(ToUtf32, SurrogatePairCombined)
{
	const char* i = "\
...
TEST(ToUtf32, SurrogatePairHigh)
{
...
TEST(ToUtf32, SurrogatePairHighStart)
{
...
TEST(ToUtf32, SurrogatePairHighEnd)
{
...
TEST(ToUtf32, SurrogatePairLowStart)
{
...
TEST(ToUtf32, SurrogatePairLowEnd)
{
...
TEST(ToUtf32, SurrogatePairOverlongHighStart)
{
...
TEST(ToUtf32, SurrogatePairOverlongHighEnd)
{
...
TEST(ToUtf32, SurrogatePairOverlongLowStart)
{
...
TEST(ToUtf32, SurrogatePairOverlongLowEnd)
{
...
TEST(ToUtf32, SurrogatePairNotEnoughData)
{
...
TEST(ToUtf32, AmountOfBytesString)
{
...
TEST(ToUtf32, AmountOfBytesNotEnoughData)
{
	const char* i = "\xC8";
	int32_t errors = 0;
...
TEST(ToUtf32, AmountOfBytesOverlong)
{
	const char* i = "\xFC\x84\x80\x80\x80\x80";
	int32_t errors = 0;
...
TEST(ToUtf32, AmountOfBytesNoData)
{
	int32_t errors = 0;
