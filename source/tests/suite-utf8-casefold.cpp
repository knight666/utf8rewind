...
TEST(Utf8CaseFold, BasicLatinSingleUppercase)
{
	...
	EXPECT_EQ(1, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("g", b);
...
TEST(Utf8CaseFold, BasicLatinSingleAmountOfBytes)
{
	...
	EXPECT_EQ(1, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, BasicLatinSingleNotEnoughSpace)
{
	...
	EXPECT_EQ(0, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("", b);
...
TEST(Utf8CaseFold, BasicLatinMultipleUppercase)
{
	...
	EXPECT_EQ(4, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, BasicLatinMultipleUnaffected)
{
	...
	EXPECT_EQ(6, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, BasicLatinMultipleAmountOfBytes)
{
	...
	EXPECT_EQ(5, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, BasicLatinMultipleNotEnoughSpace)
{
	...
	EXPECT_EQ(3, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_UTF8EQ("7bd", b);
	EXPECT_ERROREQ(UTF8_ERR_NOT_ENOUGH_SPACE, errors);
}
...
TEST(Utf8CaseFold, GeneralCategoryCaseMappedSingleUppercase)
{
	...
	EXPECT_EQ(2, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GeneralCategoryCaseMappedSingleAmountOfBytes)
{
	...
	EXPECT_EQ(2, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, GeneralCategoryCaseMappedMultipleUppercase)
{
	...
	EXPECT_EQ(9, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GeneralCategoryCaseMappedMultipleUnaffected)
{
	...
	EXPECT_EQ(8, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GeneralCategoryCaseMappedMultipleAmountOfBytes)
{
	...
	EXPECT_EQ(8, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, GraphemeClusterSingleUppercase)
{
	...
	EXPECT_EQ(11, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterSingleTitlecase)
{
	...
	EXPECT_EQ(12, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterSingleAmountOfBytes)
{
	...
	EXPECT_EQ(10, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, GraphemeClusterMultipleUppercase)
{
	...
	EXPECT_EQ(23, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterMultipleLowercase)
{
	...
	EXPECT_EQ(26, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterMultipleTitlecase)
{
	...
	EXPECT_EQ(27, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterMultipleUnaffected)
{
	...
	EXPECT_EQ(33, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, GraphemeClusterMultipleAmountOfBytes)
{
	...
	EXPECT_EQ(23, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, GraphemeClusterMultipleNotEnoughSpace)
{
	...
	EXPECT_EQ(22, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, InvalidCodepointAmountOfBytes)
{
	...
	EXPECT_EQ(3, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, InvalidCodepointMultipleAmountOfBytes)
{
	...
	EXPECT_EQ(9, utf8casefold(c, strlen(c), nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST(Utf8CaseFold, ErrorsIsReset)
{
	...
	EXPECT_EQ(7, utf8casefold(c, strlen(c), b, s, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, InvalidData)
{
	...
	EXPECT_EQ(0, utf8casefold(nullptr, 1, nullptr, 0, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, OverlappingParametersFits)
{
	...
	EXPECT_EQ(7, utf8casefold(i, is, o, os, UTF8_LOCALE_UNAFFECTED, &errors));
...
TEST(Utf8CaseFold, OverlappingParametersStartsEqual)
{
	...
	EXPECT_EQ(0, utf8casefold(i, is, o, os, UTF8_LOCALE_UNAFFECTED, &errors));
