...
TEST_F(Utf8CaseFold, BasicLatinSingleUppercase)
{
	const char* c = "G";
	const size_t s = 255;
	char b[256] = { 0 };
	...
	EXPECT_EQ(1, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("g", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinSingleLowercase)
{
	const char* c = "k";
	const size_t s = 255;
	char b[256] = { 0 };
...
TEST_F(Utf8CaseFold, BasicLatinSingleUnaffected)
{
	const char* c = "0";
	const size_t s = 255;
	char b[256] = { 0 };
...
TEST_F(Utf8CaseFold, BasicLatinSingleAmountOfBytes)
{
	const char* c = "&";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(1, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinSingleNotEnoughSpace)
{
	const char* c = "d";
	const size_t s = 0;
	char b[256] = { 0 };
	...
	EXPECT_EQ(0, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("", b);
	EXPECT_ERROREQ(UTF8_ERR_NOT_ENOUGH_SPACE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinMultipleUppercase)
{
	const char* c = "HODR";
	const size_t s = 255;
	char b[256] = { 0 };
	...
	EXPECT_EQ(4, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("hodr", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinMultipleLowercase)
{
	const char* c = "junk";
	const size_t s = 255;
	char b[256] = { 0 };
...
TEST_F(Utf8CaseFold, BasicLatinMultipleUnaffected)
{
	const char* c = "$ 1500";
	const size_t s = 255;
	char b[256] = { 0 };
	...
	EXPECT_EQ(6, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("$ 1500", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinMultipleAmountOfBytes)
{
	const char* c = "Skirt";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(5, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, BasicLatinMultipleNotEnoughSpace)
{
	const char* c = "7bD122";
	const size_t s = 3;
	char b[256] = { 0 };
	...
	EXPECT_EQ(3, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("7bd", b);
	EXPECT_ERROREQ(UTF8_ERR_NOT_ENOUGH_SPACE, errors);
}

TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleUppercase)
{
	...
	EXPECT_EQ(2, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xC9\xB2", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleLowercase)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleTitlecase)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleUnaffected)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleAmountOfBytes)
{
	...
	EXPECT_EQ(2, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedSingleNotEnoughSpace)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleUppercase)
{
	// LATIN LETTER YR
	...
	EXPECT_EQ(9, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCA\x80\xCF\x89i\xCC\x87\xC3\xB1", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleLowercase)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleTitlecase)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleUnaffected)
{
	...
	EXPECT_EQ(8, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCD\x8B\xDD\xB8\xDF\xBA\xDC\x81", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleAmountOfBytes)
{
...
TEST_F(Utf8CaseFold, GeneralCategoryCaseMappedMultipleNotEnoughSpace)
{
...
TEST_F(Utf8CaseFold, GraphemeClusterSingleUppercase)
{
	...
	EXPECT_EQ(11, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("l\xE0\xBD\xBC\xE0\xA3\xAE\xCD\x90\xD2\x85", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GraphemeClusterSingleLowercase)
{
	// 0149 0C55 0F80 0322
	//    0   84  130  222
...
TEST_F(Utf8CaseFold, GraphemeClusterSingleTitlecase)
{
	...
	EXPECT_EQ(12, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xC7\x86\xE0\xBD\xB4\xE1\xB7\x8E\xF0\x9D\x85\xA5", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GraphemeClusterSingleUnaffected)
{
	// 00A1 0E39 0F71 0F39
	//    0  103  129  216
...
TEST_F(Utf8CaseFold, GraphemeClusterSingleAmountOfBytes)
{
	// 00AB 0F7C 0328 FE2C
	//    0  130  202  220
	...
	EXPECT_EQ(10, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GraphemeClusterSingleNotEnoughSpace)
{
	// 0150 0652 0E4A 0322
	//    0   34  107  202
...
TEST_F(Utf8CaseFold, GraphemeClusterMultipleUppercase)
{
...
TEST_F(Utf8CaseFold, GraphemeClusterMultipleTitlecase)
{
	...
	EXPECT_EQ(27, utf8casefold(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8CaseFold, GraphemeClusterMultipleUnaffected)
{
	...
	EXPECT_EQ(33, utf8casefold(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8CaseFold, GraphemeClusterMultipleAmountOfBytes)
{
	...
	EXPECT_EQ(23, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, GraphemeClusterMultipleNotEnoughSpace)
{
...
TEST_F(Utf8CaseFold, InvalidCodepointAmountOfBytes)
{
	const char* c = "\xE2";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(3, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, InvalidCodepointSingleNotEnoughSpace)
{
...
TEST_F(Utf8CaseFold, InvalidCodepointMultiple)
{
...
TEST_F(Utf8CaseFold, InvalidCodepointMultipleAmountOfBytes)
{
	const char* c = "\xE7\x81\xC2\xD4";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(9, utf8casefold(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, InvalidCodepointMultipleNotEnoughSpace)
{
...
TEST_F(Utf8CaseFold, ErrorsIsReset)
{
	...
	EXPECT_EQ(7, utf8casefold(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("compare", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, InvalidData)
{
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(0, utf8casefold(nullptr, 1, nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_INVALID_DATA, errors);
}

TEST_F(Utf8CaseFold, OverlappingParametersFits)
{
	int32_t errors = UTF8_ERR_NONE;
	...
	EXPECT_EQ(7, utf8casefold(i, is, o, os, &errors));
	EXPECT_UTF8EQ("Centralcentral", data);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8CaseFold, OverlappingParametersStartsEqual)
{
	int32_t errors = UTF8_ERR_NONE;
	...
	EXPECT_EQ(0, utf8casefold(i, is, o, os, &errors));
	EXPECT_ERROREQ(UTF8_ERR_OVERLAPPING_PARAMETERS, errors);
}

TEST_F(Utf8CaseFold, OverlappingParametersEndsEqual)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersInputStartsInTarget)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersInputEndsInTarget)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersInputInsideTarget)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersTargetStartsInInput)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersTargetEndsInInput)
{
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8CaseFold, OverlappingParametersTargetInsideInput)
{
	int32_t errors = UTF8_ERR_NONE;
