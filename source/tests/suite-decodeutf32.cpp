...
TEST(DecodeUtf32, SurrogatePairHighStart)
{
...
TEST(DecodeUtf32, SurrogatePairHighEnd)
{
...
TEST(DecodeUtf32, SurrogatePairLow)
{
...
TEST(DecodeUtf32, SurrogatePairLowStart)
{
...
TEST(DecodeUtf32, SurrogatePairLowEnd)
{
