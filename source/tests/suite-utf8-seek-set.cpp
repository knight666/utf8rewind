...
TEST(Utf8SeekSet, OneByteSingle)
{
	...
	EXPECT_SEEKEQ(t, 1, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleFirst)
{
	...
	EXPECT_SEEKEQ(t, 0, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSinglePastEnd)
{
	...
	EXPECT_SEEKEQ(t, 1, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 1, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ(t, 1, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 2, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ(t, 1, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 2, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 3, 0, 0, 3, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleOverlongFourBytes)
{
	...
	EXPECT_SEEKEQ(t, 3, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 5, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleOverlongFiveBytes)
{
	...
	EXPECT_SEEKEQ(t, 4, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 5, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 6, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteSingleOverlongSixBytes)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 7, SEEK_SET);
}
...
TEST(Utf8SeekSet, OneByteMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 6, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ(t, 8, 0, 0, 8, SEEK_SET);
	EXPECT_SEEKEQ(t, 9, 0, 0, 9, SEEK_SET);
...
TEST(Utf8SeekSet, TwoBytesSingle)
{
	...
	EXPECT_SEEKEQ(t, 2, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ(t, 2, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 3, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ(t, 2, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 3, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 3, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesSingleOverlongThreeBytes)
{
	...
	EXPECT_SEEKEQ(t, 3, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 5, 0, 0, 4, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesSingleOverlongFiveBytes)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 6, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 2, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 8, 0, 0, 4, SEEK_SET);
}
...
TEST(Utf8SeekSet, TwoBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 7, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 9, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 10, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ(t, 11, 0, 0, 8, SEEK_SET);
}
...
TEST(Utf8SeekSet, ThreeBytesSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ(t, 3, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 5, 0, 0, 3, SEEK_SET);
}
...
TEST(Utf8SeekSet, ThreeBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 9, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 4, SEEK_SET);
}
...
TEST(Utf8SeekSet, ThreeBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 8, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 9, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 13, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ(t, 14, 0, 0, 8, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesSingle)
{
	...
	EXPECT_SEEKEQ(t, 4, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ(t, 4, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 5, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 4, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 8, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 16, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 20, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 10, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 11, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 13, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ(t, 17, 0, 0, 8, SEEK_SET);
	EXPECT_SEEKEQ(t, 18, 0, 0, 9, SEEK_SET);
	EXPECT_SEEKEQ(t, 19, 0, 0, 10, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesSingle)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 3, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 10, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 15, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 20, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 25, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ(t, 5, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 6, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 9, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 10, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 7, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 13, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 18, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ(t, 19, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ(t, 20, 0, 0, 8, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesSingle)
{
	...
	EXPECT_SEEKEQ(t, 6, 0, 0, 1, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultiple)
{
	...
	EXPECT_SEEKEQ(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 12, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 18, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 24, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 30, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ(t, 3, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 4, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 8, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 9, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 10, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 11, 0, 0, 6, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ(t, 7, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ(t, 13, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ(t, 14, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ(t, 20, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ(t, 21, 0, 0, 6, SEEK_SET);
}
