...
TEST(Utf8SeekSet, FourBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ2(t, 4, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 4, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 8, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 16, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 20, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ2(t, 7, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 8, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ2(t, 10, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ2(t, 11, 0, 0, 7, SEEK_SET);
}
...
TEST(Utf8SeekSet, FourBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 10, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 11, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ2(t, 13, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ2(t, 17, 0, 0, 8, SEEK_SET);
	EXPECT_SEEKEQ2(t, 18, 0, 0, 9, SEEK_SET);
	EXPECT_SEEKEQ2(t, 19, 0, 0, 10, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesSingleOverlongTwoBytes)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 3, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 10, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 15, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 20, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 25, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, FiveBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ2(t, 5, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 6, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 9, 0, 0, 4, SEEK_SET);
...
TEST(Utf8SeekSet, FiveBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 7, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 13, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ2(t, 18, 0, 0, 6, SEEK_SET);
	EXPECT_SEEKEQ2(t, 19, 0, 0, 7, SEEK_SET);
	EXPECT_SEEKEQ2(t, 20, 0, 0, 8, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesSingleOverlongOneByte)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 2, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultiple)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 12, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 18, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 24, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 30, 0, 0, 5, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultipleInvalid)
{
	...
	EXPECT_SEEKEQ2(t, 3, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 4, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 8, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 9, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 10, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ2(t, 11, 0, 0, 6, SEEK_SET);
}
...
TEST(Utf8SeekSet, SixBytesMultipleOverlong)
{
	...
	EXPECT_SEEKEQ2(t, 6, 0, 0, 1, SEEK_SET);
	EXPECT_SEEKEQ2(t, 7, 0, 0, 2, SEEK_SET);
	EXPECT_SEEKEQ2(t, 13, 0, 0, 3, SEEK_SET);
	EXPECT_SEEKEQ2(t, 14, 0, 0, 4, SEEK_SET);
	EXPECT_SEEKEQ2(t, 20, 0, 0, 5, SEEK_SET);
	EXPECT_SEEKEQ2(t, 21, 0, 0, 6, SEEK_SET);
}
