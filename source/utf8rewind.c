...
const char* seekatend(const char* src, const char* srcStart, off_t offset)
{
	int length;
	int isAscii;
	...
	case SEEK_END:
		{
			...
			return seekatend(src, textStart, -offset);
